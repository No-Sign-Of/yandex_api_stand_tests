...
def test_create_user_has_number_in_first_name_get_error_response():
        negative_assert_symbol("Анна6Мария")
...
# Тест 12. Ошибка
# Параметр fisrtName другого типа
